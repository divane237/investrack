                ...
                return (
                  <tr key={crypto.id}>
                    ...
                    <td
                      className={
                        dailyChange > 0
                          ? 'text-gr border-b-2 px-4 py-6 text-sm'
                          : dailyChange < 0
                            ? 'text- border-b-2 px-4 py-6 text-sm'
                ...
                return (
                  <tr key={crypto.id}>
                    <td className={'p-2 text-center text-sm'}>
                      <StarIcon hoverMsg="Already in" />
                    </td>
                    <td className={'border-b-2 p-2 text-sm text-stone-700'}>
                      <p>{i + 1}</p>
                    </td>
                    <td
                      className={
                        'space-x-2 border-b-2 p-4 text-right text-sm text-stone-700'
                      }
                    >
          ...
          <table className={'w-full table-auto text-right'}>
            <thead className={'border-b-2 bg-stone-100'}>
              <tr>
                ...
                <th
                  className={
                    'whitespace-nowrap py-3 text-sm font-medium tracking-wide sm:py-3'
                  }
                >
                  24h △
                </th>

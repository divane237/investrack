          ...
          {mobileMenu && (
            ...
            >
              ...
              >
                ...
                <button
                  className={
                    'flex justify-end gap-x-2 rounded-full border-2 px-2 py-1 transition-all duration-500 ease-in-out hover:bg-stone-300'
                  }
                >
                  <button className={'rounded-full bg-sky-300 px-4 py-3'}>
